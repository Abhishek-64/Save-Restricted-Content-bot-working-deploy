        ...
        try:
            ...
            try:
                ...
                if msg.media==MessageMediaType.VIDEO_NOTE:
                    ...
                    await client.edit_message_text(sender, edit_id, "Uploading audio.")
                    ...
                    await client.edit_message_text(sender, edit_id, "Uploading voice message.")
                    ...
                    await client.edit_message_text(sender, edit_id, "Uploading sticker.")
                    ...
                    await client.edit_message_text(sender, edit_id, "Uploading animation.")
                ...
                await edit.edit('File not supported! got Timeout error')
            ...
            await client.edit_message_text(sender, edit_id, "Have you joined the channel?\n`reason : {ChannelBanned, ChannelInvalid, ChannelPrivate, ChatIdInvalid, ChatInvalid}`")
            return
